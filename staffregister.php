...
<div id="nav">
    <div id="nav_wrapper">
        <ul>
			<li><a href="index.php"><img src = "12.jpg" width = "40" height = "40" alt = "heart and hands"  /></a></li>
										...
										if($queryInsert2)
										{
											...
											else
											{
												...
												if($queryInsert3)
												{
													...
													$mail->Username = 'organdonation22@gmail.com';                 // SMTP username
													$mail->Password = 'organ123$';                           // SMTP password
													$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
													$mail->Port = 587;                                    // TCP port to connect to

													$mail->setFrom('organdonation22@gmail.com', "Organ Donation Support");
									...
									if($queryInsert)
									{
										...
										if($queryInsert2)
										{
											...
											if($queryInsert3)
											{
												...
												$mail->Host = 'smtp.gmail.com';  // Specify main and backup SMTP servers
												$mail->SMTPAuth = true;                               // Enable SMTP authentication
												$mail->Username = 'organdonation22gmail.com';                 // SMTP username
												$mail->Password = 'organ123';                           // SMTP password
												$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
												$mail->Port = 587;                                    // TCP port to connect to

												$mail->setFrom('organdonation22@gmail.com', "Support");
												$mail->addAddress($accountinfo_email, $accountinfo_firstname);   // Add a recipient
												$mail->isHTML(true);                                  // Set email format to HTML
